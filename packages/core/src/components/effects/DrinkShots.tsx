...
/**
 * De "arcane shot": een bierprojectiel dat in een boog van het speelveld naar
 * de chip vliegt van de speler die moet drinken, met een +N-inslag. De inslag-
 * tekst gebruikt het gedeelde brand-token (text-brand-soft) dat elke app invult.
 */
    ...
    <div className="pointer-events-none absolute inset-0 z-30 overflow-hidden">
      ...
      <AnimatePresence>
        {hits.map((hit) => (
          <motion.span
            key={hit.key}
            className="absolute left-0 top-0 whitespace-nowrap text-lg font-extrabold text-brand-soft drop-shadow"
